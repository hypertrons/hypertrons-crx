...
const metricNameMap = new Map([
  ...
  ['attention', 'attention'],
  ['issue_reponse_time', 'issue_response_time'],
...
export const getAttention = async (platform: string, repo: string) => {
  return getMetricByName(platform, repo, metricNameMap, 'attention');
};
